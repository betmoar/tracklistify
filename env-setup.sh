...
# Install core dependencies including acrcloud and shazamio
install_dependencies() {
    print_status "Installing core dependencies..."

    # Install acrcloud from GitHub
    "$VENV_DIR/bin/pip" install git+https://github.com/acrcloud/acrcloud_sdk_python || {
        print_error "Failed to install acrcloud"
        exit 1
    }

    # Install shazamio from GitHub
    "$VENV_DIR/bin/pip" install git+https://github.com/shazamio/shazamio || {
        print_error "Failed to install shazamio"
        exit 1
    }

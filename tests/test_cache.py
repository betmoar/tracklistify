...
from tracklistify.cache.invalidation import TTLStrategy, LRUStrategy, SizeStrategy, CompositeStrategy
...
async def test_cache_lru_invalidation(temp_cache_dir: Path):
    ...
    base_cache = BaseCache[Dict[str, Any]](storage=storage, invalidation_strategy=strategy)

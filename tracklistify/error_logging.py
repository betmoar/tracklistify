...
from typing import Any, Callable, Dict, Generator, Optional, Type, TypeVar, cast
...
def create_error_context(
    ...
    return ErrorContext(
        ...
        stack_trace=''.join(traceback.format_tb(frame.f_back.f_back if frame.f_back else frame)),
...
def error_context(
    ...
    error_types: Optional[Type[Exception]] = None
